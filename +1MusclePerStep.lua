-- Youtube: Scriptyyz
-- Key System for +1 Muscle Per Step

local CorrectKey = "muscle2026" 
local KeyLink = "https://link-center.net/1377384/Ptr9QpzoUV1l"
...
-- Funkcija za proveru ključa i pokretanje glavne skripte
CheckBtn.MouseButton1Click:Connect(function()
    if KeyInput.Text == CorrectKey then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptyyz/roblox/refs/heads/main/%2B1MusclePerStep.lua"))()
    else
